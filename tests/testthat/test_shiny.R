...
testthat::test_that("Shiny app with static language",{
  ...
  if (interactive()) {
    ...
    fdishinyr::set_translation_language("fr")
    ...
    runApp(list(
      ui = bs4Dash::dashboardPage(
        ...
        body = bs4Dash::dashboardBody(
          ...
          fdishinyr::welcome_ui("welcome_you")
        ),
        controlbar = dashboardControlbar(),
        title = "DashboardPage"
      ),
      server = function(input, output) {
        fdishinyr::welcome_server("welcome_you")
      }
    ))
  } 
    ...
    runApp(list(
      ...
      server = function(input, output) {
        ...
        observeEvent(input$selected_language, {
          ...
          fdishinyr::welcome_server("welcome_you", lang = reactive({input$selected_language}))
        })
